  ...
  public static void main(String[] args) {
    ...
    // your own testing
	  ...
	  HashMap hm = new HashMap_imp(2);
	    ...
	    System.out.println(hm.getTable().length);
	 ...
	 /*
	  HashMap hm2 = new HashMap_imp(2);
	  Value v1 = new Value_imp (1,50,20);
	  Value v2 = new Value_imp (1, 100, 20);
	  
	  System.out.println(hm2.getTable().length);
	  System.out.println(hm2.extend());
	  System.out.println(hm2.getTable().length);
	  hm2.put("I", v1);
	  hm2.put("S", v2);
